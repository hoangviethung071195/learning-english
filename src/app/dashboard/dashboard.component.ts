...
import { WordListComponent } from '@app/components/word-list/word-list.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, WordListComponent, ButtonModule, FilterPipe],
  template: `
    <div class="p-4">
      <h1 class="text-3xl mb-4">English Vocabulary Dashboard</h1>
      <div class="mb-4">
        <p-button
          [label]="'All Words (' + words.length + ')'"
          (onClick)="startQuiz()"
          class="mr-2"
        ></p-button>
        <p-button
          [label]="
            'Not Checked Words (' +
            (words | filter : { key: 'status', value: 'not checked' }).length +
            ')'
          "
          (onClick)="startQuiz('not checked')"
          class="mr-2"
        ></p-button>
        <p-button
          [label]="
            'Failed Words (' +
            (words | filter : { key: 'status', value: 'failed' }).length +
            ')'
          "
          (onClick)="startQuiz('failed')"
        ></p-button>
      </div>
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    this.vocabularyService.getWords().subscribe((words) => {
      this.words = words;
    });
    console.log(
      'this.parseVocabulary(this.input) ',
      this.parseVocabulary(this.input)
    );
  }

  startQuiz(type?: 'pass' | 'not checked' | 'failed') {
    this.router.navigate(['/quiz'], {
      queryParams: { type: type },
    });
  }
  input = `abandon v. /ə'bændən/ bỏ, từ bỏ
...
busy adj. / ́bizi/ bận, bận rộn
but conj. /bʌt/ nhưng
butter n. /'bʌtə/ bơ
button n. /'bʌtn/ cái nút, cái khuy, cúc
buy v. /bai/ mua
buyer n. / ́baiə/ người mua
...
cardboard n. / ́ka:d ̧bɔ:d/ bìa cứng, các tông
...
carefully adv. / ́kɛəfuli/ cẩn thận, chu đáo
careless adj. / ́kɛəlis/ sơ suất, cầu thả
carelessly adv. cẩu thả, bất cẩn
carpet n. /'kɑ:pit/ tấm thảm, thảm (cỏ)
carrot n. / ́kærət/ củ cà rốt
...
central adj. / ́sentrəl/ trung tâm, ở giữa, trung ương
centre (BrE) (NAmE center) n. /'sentə/ điểm giữa, trung tâm, trung ương
century n. /'sentʃuri/ thế kỷ
ceremony n. / ́seriməni/ nghi thức, nghi lễ
certain adj., pron. /'sə:tn/ chắc chắn
certainly adv. / ́sə:tnli/ chắc chắn, nhất định
...
characteristic adj., n. / ̧kærəktə ́ristik/ riêng, riêng biệt, đặc trưng, đặc tính, đặc điểm
charge n., v. /tʃɑ:dʤ/ nhiệm vụ, bổn phận, trách nhiệm; giao nhiệm vụ, giao việc
in charge of phụ trách
charity n. / ́tʃæriti/ lòng từ thiện, lòng nhân đức; sự bố thí
...
cheek n. / ́tʃi:k/ má
cheerful adj. / ́tʃiəful/ vui mừng, phấn khởi, hồ hởi
cheerfully adv. vui vẻ, phấn khởi
cheese n. /tʃi:z/ pho mát
chemical adj., n. /ˈkɛmɪkəl/ thuộc hóa học; chất hóa học, hóa chất
chemist n. / ́kemist/ nhà hóa học
chemist’s n. (BrE)
chemistry n. / ́kemistri/ hóa học, môn hóa học, ngành hóa học
...
cigarette n. / ̧sigə ́ret/ điếu thuốc lá
...
citizen n. / ́sitizən/ người thành thị
...
clearly adv. / ́kliəli/ rõ ràng, sáng sủa
...
clothing n. / ́klouðiη/ quần áo, y phục
cloud n. /klaud/ mây, đám mây
club n. / ́klʌb/ câu lạc bộ; gậy, dùi cui
...
collect v. /kə ́lekt/ sưu tập, tập trung lại
...
comfortably adv. / ́kʌmfətəbli/ dễ chịu, thoải mái, tiện nghi, ấm cúng
uncomfortable adj. /ʌη ́tkʌmfətəbl/ bất tiện, khó chịu, không thoải mái
...
commonly adv. / ́kɔmənli/ thông thường, bình thường
...
competitive adj. /kəm ́petitiv/ cạnh tranh, đua tranh
complain v. /kəm ́plein/ phàn nàn, kêu ca
...
concerned adj. /kən ́sə:nd/ có liên quan, có dính líu
concerning prep. /kən ́sə:niη/ bâng khuâng, ái ngại
...
connection n. /kə ́nekʃən,/ sự kết nối, sự giao kết
...
conservative adj. /kən ́sə:vətiv/ thận trọng, dè dặt, bảo thủ
consider v. /kən ́sidə/ cân nhắc, xem xét; để ý, quan tâm, lưu ý đến
...
construct v. /kən ́strʌkt/ xây dựng
...
contest n. /kən ́test/ cuộc thi, trận đấu, cuộc tranh luận, cuộc chiến đấu, chiến tranh
context n. /'kɔntekst/ văn cảnh, khung cảnh, phạm vi
continent n. /'kɔntinənt/ lục địa, đại lục (lục địa Bắc Mỹ)
continue v. /kən ́tinju:/ tiếp tục, làm tiếp
...
cooker n. (BrE) / ́kukə/ lò, bếp, nồi nấu
cookie n. (especially NAmE) / ́kuki/ bánh quy
...
corner n. / ́kɔ:nə/ góc (tường, nhà, phố...)
correct adj., v. /kə ́rekt/ đúng, chính xác; sửa, sửa chữa
correctly adv. /kə ́rektli/ đúng, chính xác
...
crucial adj. / ́kru:ʃəl/ quyết định, cốt yếu, chủ yếu
...
customer n. / ́kʌstəmə/ khách hàng
customs n. / ́kʌstəmz/ thuế nhập khẩu, hải quan
...
decorate v. / ́dekə ̧reit/ trang hoàng, trang trí
decoration n. / ̧dekə ́reiʃən/ sự trang hoàng, đồ trang hoàng, trang trí
decorative adj. / ́dekərətiv/ để trang hoàng, để trang trí, để làm cảnh
decrease v., n. / 'di:kri:s/ giảm bớt, làm suy giảm, sự giảm đi, sự giảm sút
deep adj., adv. /di:p/ sâu, khó lường, bí ẩn
deeply adv. / ́di:pli/ sâu, sâu xa, sâu sắc
...
deliberately adv. /di ́libəritli/ thận trọng, có suy nghĩ cân nhắc
...
depress v. /di ́pres/ làm chán nản, làm phiền muộn; làm suy giảm
...
derive v. /di ́raiv/ nhận được từ, lấy được từ; xuất phát từ, bắt nguồn, chuyển hóa từ
(from)
...
design n., v. /di ́zain/ sự thiết kế, kế hoạch, đề cương. phác thảo; phác họa, thiết kế
...
determined adj. /di ́tə:mind/ đã được xác định, đã được xác định rõ
...
devoted adj. /di ́voutid/ hiến cho, dâng cho, dành cho; hết lòng, nhiệt tình
diagram n. /ˈdaɪəˌgræm/ biểu đồ
diamond n. / ́daiəmənd/ kim cương
...
khiển
directly adv. /dai ́rektli/ trực tiếp, thẳng
...
dirty adj. / ́də:ti/ bẩn thỉu, dơ bẩn
disabled adj. /dis ́eibld/ bất lực, không có khă năng
disadvantage n. /ˌdɪsədˈvæntɪdʒ , ˌdɪsədˈvɑntɪdʒ/sự bất lợi, sự thiệt hại
disagree v. / ̧disə ́gri:/ bất đồng, không đồng ý, khác, không giống; không hợp
disagreement n. / ̧disəg ́ri:mənt/ sự bất đồng, sự không đồng ý, sự khác nhau
disappear v. /disə'piə/ biến mất, biến đidisappoint v. /ˌdɪsəˈpɔɪnt/ không làm thỏa ước nguyện, ý mong đợi; thất ước, làm thất
bại
disappointing adj. / ̧disə ́pɔintiη/ làm chán ngán, làm thất vọng
disappointed adj. /,disз'pointid/ thất vọng
disappointment n. / ̧disə ́pɔintmənt/ sự chán ngán, sự thất vọng
disapproval n. / ̧disə ́pru:vl/ sự phản đổi, sự không tán thành
disapprove (of) v. / ̧disə ́pru:v/ không tán thành, phản đối, chê
disapproving adj. / ̧disə ́pru:viη/ phản đối
...
disgust v., n. /dis ́gʌst/ làm ghê tởm, làm kinh tởm, làm phẫn nộ
disgusting adj. /dis ́gʌstiη/ làm ghê tởm, kinh tởm
disgusted adj. /dis ́gʌstid/ chán ghét, phẫn nộ
dish n. /diʃ/ đĩa (đựng thức ăn)
dishonest adj. /dis ́ɔnist/ bất lương, không thành thật
...
distinguish v. /dis ́tiηgwiʃ/ phân biệt, nhận ra, nghe ra
...
downwards (also downward especially in NAmE) adv. / ́daun ̧wədz/ xuống, đi xuống
downward adj. / ́daun ̧wəd/ xuống, đi xuống
...
dramatic adj. /drə ́mætik/ như kịch, như đóng kịch, thích hợp với sân khấu
dramatically adv. /drə'mætikəli/ đột ngột
draw v. /dro:/ vẽ, kéo
drawing n. /'dro:iŋ/ bản vẽ, bức vẽ, sự kéo
drawer n. / ́drɔ:ə/ người vẽ, người kéo
...
effort n. / ́efə:t/ sự cố gắng, sự nỗ lực
e.g. abbr. Viết tắt của cụm từ La tinh exempli gratia (for example)
egg n. /eg/ trứng
either det., pron., adv. / ́aiðə/ mỗi, một; cũng phải thế
elbow n. /elbou/ khuỷu tay
elderly adj. / ́eldəli/ có tuổi, cao tuổi
elect v. /i ́lekt/ bầu, quyết định
election n. /i ́lekʃən/ sự bầu cử, cuộc tuyển cử
...
elegant adj. / ́eligənt/ thanh lịch, tao nhã
element n. /ˈɛləmənt/ yếu tôd, nguyên tố
elevator n. (NAmE) /ˈɛləˌveɪtər/ máy nâng, thang máy
else adv. /els/ khác, nữa; nếu không
elsewhere adv. / ̧els ́wɛə/ ở một nơi nào khác
email (also e-mail) n., v. /'imeil/ thư điện tử; gửi thư điện tử
embarrass v. /im ́bærəs/ lúng túng, làm ngượng nghịu; làm rắc rối, gây khó khăn
embarrassing adj. /im ́bærəsiη/ làm lúng túng, ngăn trở
embarrassed adj. /im ́bærəst/ lúng túng, bối rối, ngượng; mang nợ
embarrassment n. /im ́bærəsmənt/ sự lúng túng, sự bối rối
emerge v. /i ́mə:dʒ/ nổi lên, hiện ra; nổi bật lên
emergency n. /i'mз:dЗensi/ tình trạng khẩn cấp
emotion n. /i'moƱʃ(ə)n/ xự xúc động, sự cảm động, mối xác cảm
emotional adj. /i ́mouʃənəl/ cảm động, xúc động, xúc cảm; dễ cảm động, dễ xúc cảm
emotionally adv. /i ́mouʃənəli/ xúc động
emphasis n. / ́emfəsis/ sự nhấn mạnh, tầm quan trọng
...
unemployed adj. / ̧ʌnim ́plɔid/ thất nghiệp; không dùng, không sử dụng được
employee n. / ̧emplɔi ́i:/ người lao động, người làm công
employer n. /em ́plɔiə/ chủ, người sử dụng lao động
...
enjoyable adj. /in ́dʒɔiəbl/ thú vị, thích thú
enjoyment n. /in ́dʒɔimənt/ sự thích thú, sự có được, được hưởng
...
enter v. / ́entə/ đi vào, gia nhập
entertain v. /,entə'tein/ giải trí, tiếp đón, chiêu đãi
entertaining adj. /,entə'teiniɳ/ giải trí
entertainer n. / ̧entə ́teinə/ người quản trò, người tiếp đãi, chiêu đãi
...
entirely adv. /in ́taiəli/ toàn vẹn, trọn vẹn, toàn bộ
...
equal adj., n., v. / ́i:kwəl/ ngang, bằng; người ngang hàng, ngang tài, sức; bằng,
ngang
equally adv. /'i:kwзli / bằng nhau, ngang bằng
equipment n. /i'kwipmənt/ trang, thiết bị
equivalent adj., n. /i ́kwivələnt/ tương đương; từ, vật tương đương
...
essentially adv. /e ̧senʃi ́əli/ về bản chất, về cơ bản
...
euro n. / ́ju:rou/ đơn vị tiền tệ của liên minh châu Âu
...
eventually adv. /i ́ventjuəli/ cuối cùng
ever adv. /'evə(r)/ từng, từ trước tới giờ
every det. /'evəri/ mỗi, mọi
everyone (also everybody) pron. / ́evri ̧wʌn/ mọi người
everything pron. /'evriθiɳ/ mọi vật, mọi thứ
everywhere adv. / ́evri ̧weə/ mọi nơi
...
exact adj. /ig ́zækt/ chính xác, đúng
exactly adv. /ig ́zæktli/ chính xác, đúng đắn
exaggerate v. /ig ́zædʒə ̧reit/ cường điệu, phóng đại
exaggerated adj. /ig'zædЗзreit/ cường điệu, phòng đại
exam n. /ig ́zæm/ viết tắt của Examination (xem nghĩa phía dưới)
examination /ig ̧zæmi ́neiʃən/ n. sự thi cử, kỳ thi
examine v. /ɪgˈzæmɪn/ thẩm tra, khám xét, hỏi han (thí sinh)
example n. /ig ́za:mp(ə)l/ thí dụ, ví dụ
...
exchange v., n. /iks ́tʃeindʒ/ trao đổi; sự trao đổi
in exchange (for) trong việc trao đổi về
excite v. /ik'sait/ kích thích, kích động
exciting adj. /ik ́saitiη/ hứng thú, thú vị
excited adj. /ɪkˈsaɪtɪd/ bị kích thích, bị kích động
excitement n. /ik ́saitmənt/ sự kích thích, sự kích động
exclude v. /iks ́klu:d/ ngăn chạn, loại trừ
excluding prep. /iks ́klu:diη/ ngoài ra, trừ ra
excuse n., v. /iks ́kju:z/ lời xin lỗi, bào chữa; xin lỗi, tha thứ, tha lỗi
...
exit n. / ́egzit/ lỗi ra, sự đi ra, thoát ra
expand v. /iks'pænd/ mở rộng, phát triển, nở, giãn ra
expect v. /ik'spekt/ chờ đợi, mong ngóng; liệu trước
expected adj. /iks ́pektid/ được chờ đợi, được hy vọng
unexpected adj. / ̧ʌniks ́pektid/ bất ngờ, gây ngạc nhiên
...
experienced adj. /eks ́piəriənst/ có kinh nghiệm, từng trải, giàu kinh nghiệm
...
explore v. /iks ́plɔ:/ thăm dò, thám hiểm
explosion n. /iks'plouʤn/ sự nổ, sự phát triển ồ ạt
export v., n. /iks ́pɔ:t/ xuất khẩu; hàng xuất khẩu, sự xuất khẩu
...
extensive adj. /iks ́tensiv/ rộng rãi, bao quát
...
extremely adv. /iks ́tri:mli/ vô cùng, cực độ
eye n. /ai/ mắt
...
unfair adj. /ʌn ́fɛə/ gian lận, không công bằng; bất lợi
unfairly adv. /ʌn ́fɛəli/ gian lận, không công bằng; bất lợi
...
February n. (abbr. Feb.) / ́februəri/ tháng 2
...
female adj., n. / ́fi:meil/ thuộc giống cái; giống cái
...
fighting n. / ́faitiη/ sự chiến đấu, sự đấu tranh
...
finally adv. / ́fainəli/ cuối cùng, sau cùng
...
finely adv. / ́fainli/ đẹp đẽ, tế nhị, cao thượng
...
former adj. / ́fɔ:mə/ trước, cũ, xưa, nguyên
formerly adv. / ́fɔ:məli/ trước đây, thuở xưa
...
freely adv. / ́fri:li/ tự do, thoải mái
...
frequently adv. / ́fri:kwəntli/ thường xuyên
fresh adj. /freʃ/ tươi, tươi tắn
freshly adv. / ́freʃli/ tươi mát, khỏe khoắn
Friday n. (abbr. Fri.) / ́fraidi/ thứ Sáu
fridge n. (BrE) /fridЗ/ tủ lạnh
friend n. /frend/ người bạn
make friends (with) kết bạn với
friendly adj. / ́frendli/ thân thiện, thân mật
unfriendly adj. /ʌn ́frendli/ không thân thiện, không có thiện cảm
friendship n. /'frendʃipn/ tình bạn, tình hữu nghị
frighten v. /ˈfraɪtn/ làm sợ, làm hoảng sợ
frightening adj. / ́fraiəniη/ kinh khủng, khủng khiếp
...
fully adv. / ́fuli/ đầy đủ, hoàn toàn
...
funny adj. / ́fʌni/ buồn cười, khôi hài
...
generous adj. / ́dʒenərəs/ rộng lượng, khoan hồng, hào phóng
...
genuine adj. / ́dʒenjuin/ thành thật, chân thật; xác thực
genuinely adv. / ́dʒenjuinli/ thành thật, chân thật
geography n. /dʒi ́ɔgrəfi/ địa lý, khoa địa lý
...
global adj. v / ́gloubl/ toàn cầu, toàn thể, toàn bộ
...
good at tiến bộ ở
good for có lợi cho
goodbye exclamation, n. / ̧gud ́bai/ tạm biệt; lời chào tạm biệt
goods n. /gudz/ của cải, tài sản, hàng hóa
govern v. / ́gʌvən/ cai trị, thống trị, cầm quyền
government n. /ˈgʌvərnmənt , ˈgʌvərmənt/ chính phủ, nội các; sự cai trị
governor n. / ́gʌvənə/ thủ lĩnh, chủ; kẻ thống trị
grab v. /græb/ túm lấy, vồ, chộp lấy
grade n., v. /greɪd/ điểm, điểm số; phân loại, xếp loại
gradual adj. / ́grædjuəl/ dần dần, từng bước một
...
grandchild n. / ́græn ̧tʃaild/ cháu (của ông bà)
granddaughter n. /'græn,do:tз/ cháu gái
grandfather n. / ́græn ̧fa:ðə/ ông
grandmother n. /'græn,mʌðə/ bà
grandparent n. / ́græn ̧pɛərənts/ ông bà
grandson n. / ́grænsʌn/ cháu trai
grant v., n. /grα:nt/ cho, ban, cấp; sự cho, sự ban, sự cấp
grass n. /grɑ:s/ cỏ; bãi cỏ, đồng cỏ
grateful adj. / ́greitful/ biết ơn, dễ chịu, khoan khoái
...
greatly adv. / ́greitli/ rất, lắm; cao thượng, cao cả
green adj., n. /grin/ xanh lá cây
grey (BrE) (NAmE usually gray) adj., n.
grocery (NAmE usually grocery store) n. / ́grousəri/ cửa hàng tạp phẩm
...
habit n. / ́hæbit/ thói quen, tập quán
hair n. /heə/ tóc
...
unhappiness n. /ʌn ́hæpinis/ nỗi buồn, sự bất hạnh
happy adj. /ˈhæpi/ vui sướng, hạnh phúc
happily adv. /'hæpili/ sung sướng, hạnh phúc
unhappy adj. /ʌn ́hæpi/ buồn rầu, khốn khổ
hard adj., adv. /ha:d/ cứng, rắn, hà khắc; hết sức cố gắng, tích cực
hardly adv. / ́ha:dli/ khắc nghiệt, nghiêm khắc, tàn tệ, khó khăn
harm n., v. /hɑ:m/ thiệt hại, tổn hao; làm hại, gây thiệt hại
harmful adj. / ́ha:mful/ gây tai hại, có hại
harmless adj. / ́ha:mlis/ không có hại
hat n. /hæt/ cái mũ
...
heavily adv. / ́hevili/ nặng, nặng nề
...
helpful adj. / ́helpful/ có ích; giúp đỡ
...
herself pron. /hə: ́self/ chính nó, chính cô ta, chính chị ta, chính bà ta
...
highly adv. / ́haili/ tốt, cao; hết sức, ở mức độ cao
highlight v., n. /ˈhaɪˌlaɪt/ làm nổi bật, nêu bật; chỗ nổi bật nhất, đẹp, sáng nhất
highway n. (especially NAmE) / ́haiwei/ đường quốc lộ
hill n. /hil/ đồi
him pron. /him/ nó, hắn, ông ấy, anh ấy
himself pron. /him ́self/ chính nó, chính hắn, chính ông ta, chính anh ta
hip n. /hip/ hông
...
history n. / ́histəri/ lịch sử, sử học
...
homework n. / ́houm ̧wə:k/ bài tập về nhà (học sinh), công việc làm ở nhà
...
horror n. / ́hɔrə/ điều kinh khủng, sự ghê rợn
horse n. /hɔrs/ ngựa
...
hotel n. /hou ́tel/ khách sạn
hour n. /'auз/ giờ
house n. /haus/ nhà, căn nhà, toàn nhà
housing n. / ́hauziη/ nơi ăn chốn ở
household n., adj. / ́haushould/ hộ, gia đình; (thuộc) gia đình
how adv. /hau/ thế nào, như thế nào, làm sao, ra sao
however adv. /hau ́evə/ tuy nhiên, tuy vậy, dù thế nào
huge adj. /hjuːdʒ/ to lớn, khổng lồ
human adj., n. /'hju:mən/ (thuộc) con người, loài người
humorous adj. / ́hju:mərəs/ hài hước, hóm hỉnh
humour (BrE) (NAmE humor) n. / ́hju:mə/ sự hài hước, sự hóm hỉnh
...
husband n. / ́hʌzbənd/ người chồng
...
illegal adj. /i ́li:gl/ trái luật, bất hợp pháp
illegally adv. /i ́li:gəli/ trái luật, bất hợp pháp
illness n. / ́ilnis/ sự đau yếu, ốm, bệnh tật
illustrate v. / ́ilə ̧streit/ minh họa, làm rõ ý
image n. / ́imidʒ/ ảnh, hình ảnh
imaginary adj. /i ́mædʒinəri/ tưởng tượng, ảo
...
immoral adj. /i ́mɔrəl/ trái đạo đức, luân lý; xấu xa
...
implication n. / ̧impli ́keiʃən/ sự lôi kéo, sự liên can, điều gợi ý
...
unimportant adj. / ̧ʌnim ́pɔ:tənt/ khônh quan trọng, không trọng đại
...
indicate v. / ́indikeit/ chỉ, cho biết; biểu thị, trình bày ngắn gọn
indication n. /,indi'kei∫n/ sự chỉ, sự biểu thị, sự biểu lộ
indirect adj. / ̧indi ́rekt/ gián tiếp
indirectly adv. /,indi'rektli/ gián tiếp
individual adj., n. /indivídʤuəl/ riêng, riêng biệt; cá nhân
indoors adv. / ̧in ́dɔ:z/ ở trong nhà
indoor adj. / ́in ̧dɔ:/ trong nhà
industrial adj. /in ́dʌstriəl/ (thuộc) công nghiệp, kỹ nghệ
industry n. /'indəstri/ công nghiệp, kỹ nghệ
inevitable adj. /in ́evitəbl/ không thể tránh được, chắc chắn xảy ra; vẫn thường thấy,
nghe
...
instead of thay cho
institute n. /ˈ ́institju:t/ viện, học viện
...
insulting adj. /in ́sʌltiη/ lăng mạ, xỉ nhục
...
intended adj. /in ́tendid/ có ý định, có dụng ý
...
introduction n. / ̧intrə ́dʌkʃən/ sự giới thiệu, lời giới thiệu
...
investigation n. /in ̧vesti ́geiʃən/ sự điều tra, nghiên cứu
...
irritate v. / ́iri ̧teit/ làm phát cáu, chọc tức
irritating adj. / ́iriteitiη/ làm phát cáu, chọc tức
irritated adj. /'iriteitid/ tức giận, cáu tiết
-ish suffix
island n. / ́ailənd/ hòn đảo
...
itself pron. /it ́self/ chính cái đó, chính điều đó, chính con vật đó
...
journalist n. / ́dʒə:nəlist/ nhà báo
...
killing n. / ́kiliη/ sự giết chóc, sự tàn sát
kilogram (BrE also kilogramme) (also kilo) n. (abbr. kg) / ́kilou ̧græm/ Kilôgam
kilometre (BrE) (NAmE kilometer) n. (abbr. k, km) / ́kilə ̧mi:tə/ Kilômet
kind n., adj. /kaind/ loại, giống; tử tế, có lòng tốt
kindly adv. / ́kaindli/ tử tế, tốt bụng
unkind adj. /ʌn ́kaind/ độc ác, tàn nhẫn
kindness n. /'kaindnis/ sự tử tế, lòng tốt
king n. /kiɳ/ vua, quốc vương
kiss v., n. /kis/ hôn, cái hôn
kitchen n. / ́kitʃin/ bếp
kilometre n. / ́kilə ̧mi:tə/ Kilômet
knee n. /ni:/ đầu gối
knife n. /naif/ con dao
knit v. /nit/ đan, thêu
knitted adj. /nitid/ được đan, được thêu
knitting n. / ́nitiη/ việc đan; hàng dệt kim
knock v., n. /nɔk/ đánh, đập; cú đánh
knot n. /nɔt/ cái nơ; điểm nút, điểm trung tâm
know v. /nou/ biết
unknown adj. /'ʌn'noun/ không biết
well known adj. / ́wel ́noun/ nổi tiếng, được nhiều người biết đến
...
largely adv. / ́la:dʒli/ phong phú, ở mức độ lớn
...
latter adj., n. / ́lætə/ sau cùng, gần đây, mới đây
...
leading adj. / ́li:diη/ lãnh đạo, dẫn đầu
leader n. / ́li:də/ người lãnh đạo, lãnh tụ
...
lightly adv. / ́laitli/ nhẹ nhàng
like prep., v., conj. /laik/ giống như; thích; như
unlike prep., adj. /ʌn ́laik/ khác, không giống
likely adj., adv. / ́laikli/ có thể đúng, có thể xảy ra, có khả năng; có thể, chắc vậy
...
litre (BrE) (NAmE liter) n. (abbr. l) / ́li:tə/ lít
...
unload v. /ʌn ́loud/ cất gánh nặng, dỡ hàng
...
loosely adv. / ́lu:sli/ lỏng lẻo
lord n. /lɔrd/ Chúa, vua
lorry n. (BrE) / ́lɔ:ri/ xe tải
...
lover n. / ́lʌvə/ người yêu, người tình
...
unlucky adj. /ʌn ́lʌki/ không gặp may, bất hạnh
...
mainly adv. / ́meinli/ chính, chủ yếu, phần lớn
maintain v. /mein ́tein/ giữ gìn, duy trì, bảo vệ
...
make-up n. / ́meik ̧ʌp/ đồ hóa trang, son phấn
...
manufacturing n. / ̧mænju ́fæktʃəriη/ sự sản xuất, sự chế tạo
manufacturer n. / ̧mæni ́fæktʃərə/ người chế tạo, người sản xuất
...
married adj. / ́mærid/ cưới, kết hôn
...
matching adj. / ́mætʃiη/ tính địch thù, thi đấu
mate n., v. /meit/ bạn, bạn nghề; giao phối
material n., adj. /mə ́tiəriəl/ nguyên vật liệu; vật chất, hữu hình
...
maximum adj., n. / ́mæksiməm/ cực độ, tối đa; trị số cực đại, lượng cực đại, cực độ
may modal v. /mei/ có thể, có lẽ
May n. /mei/ tháng 5
maybe adv. / ́mei ̧bi:/ có thể, có lẽ
...
meat n. /mi:t/ thịt
media n. / ́mi:diə/ phương tiện truyền thông đại chúng
...
mentally adv. / ́mentəli/ về mặt tinh thần
...
metre (BrE) (NAmE meter) n. / ́mi:tə/ mét
mid- combining form tiền tố: một nửa
midday n. / ́mid ́dei/ trưa, buổi trưa
...
milk n. /milk/ sữa
milligram (BrE also milligramme) n. (abbr. mg) / ́mili ̧græm/ mi-li-gam
millimetre (NAmE millimeter) n. (abbr. mm) / ́mili ̧mi:tə/ mi-li-met
...
minister n. / ́ministə/ bộ trưởng
ministry n. / ́ministri/ bộ
minor adj. / ́mainə/ nhỏ hơn, thứ yếu, không quan trọng
minority n. /mai ́nɔriti/ phần ít, thiểu số
minute n. /'minit/ phút
mirror n. /ˈmɪrər/ gương
miss v., n. /mis/ lỡ, trượt; sự trượt, sự thiếu vắng
Miss n. /mis/ cô gái, thiếu nữ
missing adj. / ́misiη/ vắng, thiếu, thất lạc
mistake n., v. /mis'teik/ lỗi, sai lầm, lỗi lầm; phạm lỗi, phạm sai lầm
mistaken adj. /mis ́teiken/ sai lầm, hiểu lầm
...
moreover adv. /mɔ: ́rouvə/ hơn nữa, ngoài ra, vả lại
morning n. /'mɔ:niɳ/ buổi sáng
most det., pron., adv. /moust/ lớn nhất, nhiều nhất; nhất, hơn cả
mostly adv. / ́moustli/ hầu hết, chủ yếu là
mother n. /'mΔðз/ mẹ
motion n. / ́mouʃən/ sự chuyển động, sụ di động
motor n. / ́moutə/ động cơ mô tô
...
movie n. (especially NAmE) / ́mu:vi/ phim xi nê
...
nicely adv. / ́naisli/ thú vị, dễ chịu
...
noisy adj. / ́nɔizi/ ồn ào, huyên náo
noisily adv. / ́nɔizili/ ồn ào, huyên náo
non- prefix
none pron. /nʌn/ không ai, không người, vật gì
nonsense n. / ́nɔnsəns/ lời nói vô lý, vô nghĩa
...
November n. (abbr. Nov.) /nou ́vembə/ tháng 11
now adv. /nau/ bây giờ, hiện giờ, hiện nay
nowhere adv. / ́nou ̧wɛə/ không nơi nào, không ở đâu
nuclear adj. /'nju:kliз/ (thuộc) hạt nhân
number (abbr. No., no.) n. / ́nʌmbə/ số
nurse n. /nə:s/ y tá
...
objective n., adj. /əb ́dʒektiv/ mục tiêu, mục đích; (thuộc) mục tiêu, khách quan
...
October n. (abbr. Oct.) /ɔk ́toubə/ tháng 10
odd adj. /ɔd/ kỳ quặc, kỳ cục, lẻ (số)
oddly adv. / ́ɔdli/ kỳ quặc, kỳ cục, lẻ (số)
of prep. /ɔv/ or /əv/ của
off adv., prep. /ɔ:f/ tắt; khỏi, cách, rời
offence (BrE) (NAmE offense) n. /ə'fens/ sự vi phạm, sự phạm tội
offend v. /ə ́fend/ xúc phạm, làm bực mình, làm khó chịu
offensive adj. /ə ́fensiv/ sự tấn công, cuộc tấn công
offer v., n. / ́ɔfə/ biếu, tặng, cho; sự trả giá
office n. /'ɔfis/ cơ quan, văn phòng, bộ
officer n. / ́ɔfisə/ viên chức, cảnh sát, sĩ quan
...
onto prep. / ́ɔntu/ về phía trên, lên trên
open adj., v. /'oupən/ mở, ngỏ; mở, bắt đầu, khai mạc
openly adv. / ́oupənli/ công khai, thẳng thắn
opening n. / ́oupniη/ khe hở, lỗ; sự bắt đầu, sự khai mạc, lễ khánh thành
...
opposed to /ə ́pouzd/ chống lại, phản đối
opposite adj., adv., n., prep. /'ɔpəzit/ đối nhau, ngược nhau; trước mặt, đối diện; điều
trái ngược
opposition n. / ̧ɔpə ́ziʃən/ sự đối lập, sự đối nhau; sự chống lại, sự phản đối; phe đối
lập
...
organize (BrE also -ise) v. / ́ɔ:gə ̧naiz/ tổ chức, thiết lập
...
otherwise adv. / ́ʌðə ̧waiz/ khác, cách khác; nếu không thì...; mặt khác
...
ourselves pron. / ́awə ́selvz/ bản thân chúng ta, bản thân chúng tôi, bản thân chúng
mình; tự chúng mình
out (of) adv., prep. /aut/ ngoài, ở ngoài, ra ngoài
outdoors adv. / ̧aut ́dɔ:z/ ở ngoài trời, ở ngoài nhà
outdoor adj. /'autdɔ:/ ngoài trời, ở ngoài
outer adj. outer ở phía ngoài, ở xa hơn
outline v., n. / ́aut ̧lain/ vẽ, phác tảo; đường nét, hình dáng, nét ngoài
output n. /'autput/ sự sản xuất; sản phẩm, sản lượng
outside n., adj., prep., adv. /'aut'said/ bề ngoài, bên ngoài; ở ngoài; ngoài
outstanding adj. / ̧aut ́stændiη/ nổi bật, đáng chú ý; còn tồn lại
oven n. /ʌvn/ lò (nướng)
...
owner n. / ́ounə/ người chủ, chủ nhân
...
particular adj. /pə ́tikjulə/ riêng biệt, cá biệt
particularly adv. /pə ́tikjuləli/ một cách đặc biệt, cá biệt, riêng biệt
partly adv. / ́pa:tli/ đến chừng mực nào đó, phần nào đó
partner n. /'pɑ:tnə/ đối tác, cộng sự
partnership n. / ́pa:tnəʃip/ sự chung phần, sự cộng tác
party n. /ˈpɑrti/ tiệc, buổi liên hoan; đảng
pass v. / ́pa:s/ qua, vượt qua, ngang qua
passing n., adj. / ́pa:siη/ sự đi qua, sự trôi qua; thoáng qua, ngắn ngủi
passage n. /ˈpæsɪdʒ/ sự đi qua, sự trôi qua; hành lang
passenger n. /'pæsindʤə/ hành khách
passport n. / ́pa:spɔ:t/ hộ chiếu
past adj., n., prep., adv. /pɑ:st/ quá khứ, dĩ vãng; quá, qua
path n. /pɑ:θ/ đường mòn; hướng đi
patience n. / ́peiʃəns/ tính kiên nhẫn, nhẫn nại, kiên trì, sự chịu đựng
...
personally adv. / ́pə:sənəli/ đích thân, bản thân, về phần rôi, đối với tôi
...
photocopy n., v. / ́foutə ̧kɔpi/ bản sao chụp; sao chụp
photograph n., v. (also photo n.) / ́foutə ̧gra:f/ ảnh, bức ảnh; chụp ảnh
photographer n. /fə ́tɔgrəfə/ thợ chụp ảnh, nhà nhiếp ảnh
photography n. /fə ́tɔgrəfi/ thuật chụp ảnh, nghề nhiếp ảnh
phrase n. /freiz/ câu; thành ngữ, cụm từ
physical adj. / ́fizikl/ vật chất; (thuộc) cơ thể, thân thể
physically adv. / ́fizikli/ về thân thể, theo luật tự nhiên
...
pill n. / ́pil/ viên thuốc
pilot n. / ́paiələt/ phi công
...
pity n. / ́piti/ lòng thương hại, điều đáng tiếc, đáng thương
...
pleasing adj. / ́pli:siη/ mang lại niềm vui thích; dễ chịu
...
pointed adj. / ́pɔintid/ nhọn, có đầu nhọn
...
politician n. / ̧pɔli ́tiʃən/ nhà chính trị, chính khách
...
popular adj. / ́pɔpjulə/ có tính đại chúng, (thuộc) nhân dân; được nhiều người ưa
chuộng
...
possibility n. / ̧pɔsi ́biliti/ khă năng, triển vọng
possible adj. /'pɔsibəl/ có thể, có thể thực hiện
possibly adv. / ́pɔsibli/ có lẽ, có thể, có thể chấp nhận được
...
powerful adj. / ́pauəful/ hùng mạnh, hùng cường
practical adj. /ˈpræktɪkəl/ thực hành; thực tế
practically adv. / ́præktikəli/ về mặt thực hành; thực tế
practice n. (BrE, NAmE), v. (NAmE) / ́præktis/ thực hành, thực tiễn
practise v. (BrE) / ́præktis/ thực hành, tập luyện
praise n., v. /preiz/ sự ca ngợi, sự tán dương, lòng tôn kính, tôn thờ; khen ngợi, tán
dương
prayer n. /prɛər/ sự cầu nguyện
precise adj. /pri ́sais/ rõ ràng, chính xác; tỉ mỉ, kỹ tính
precisely adv. /pri ́saisli/ đúng, chính xác, cần thận
...
preparation n. / ̧prepə ́reiʃən/ sự sửa soạn, sự chuẩn bị
prepare v. /pri ́peə/ sửa soạn, chuẩn bị
...
president n. / ́prezidənt/ hiệu trưởng, chủ tịnh, tổng thống
...
previously adv. / ́pri:viəsli/ trước, trước đây
price n. /prais/ giá
...
học
primarily adv. / ́praimərili/ trước hết, đầu tiên
prime minister n. / ́ministə/ thủ tướng
...
printing n. / ́printiη/ sự in, thuật in, kỹ sảo in
printer n. / ́printə/ máy in, thợ in
prior adj. /'praɪə(r)/ trước, ưu tiên
priority n. /prai ́ɔriti/ sự ưu tế, quyền ưu tiên
...
probable adj. / ́prɔbəbl/ có thể, có khả năng
probably adv. / ́prɔbəbli/ hầu như chắc chắn
problem n. /'prɔbləm/ vấn đề, điều khó giải quyết
procedure n. /prə ́si:dʒə/ thủ tục
...
producer n. /prə ́dju:sə/ nhà sản xuất
product n. / ́prɔdʌkt/ sản phẩm
production n. /prə ́dʌkʃən/ sự sản xuất, chế tạo
profession n. /prə ́feʃ(ə)n/ nghề, nghề nghiệp
...
program n., v. / ́prougræm/ chương trình; lên chương trình
programme n. (BrE) / ́prougræm/ chương trình
...
promptly adv. / ́prɔmptli/ mau lẹ, ngay lập tức
pronounce v. /prəˈnaʊns/ tuyên bố, thông báo, phát âm
pronunciation n. /prə ̧nʌnsi ́eiʃən/ sự phát âm
proof n. /pru:f/ chứng, chứng cớ, bằng chứng; sự kiểm chứng
proper adj. /'prɔpə/ đúng, thích đáng, thích hợp
properly adv. / ́prɔpəli/ một cách đúng đắn, một cách thích đáng
...
prospect n. / ́prɔspekt/ viễn cảnh, toàn cảnh; triển vọng, mong chờ
...
provided (also providing) conj. /prə ́vaidid/ với điều kiện là, miễn là
...
publishing n. / ́pʌbliʃiη/ công việc, nghề xuất bản
...
purely adv. / ́pjuəli/ hoàn toàn, chỉ là
...
qualify v. /' ́kwɔli ̧fai/ đủ khả năng, đủ tư cách, điều kiện
...
racing n. / ́reisiη/ cuộc đua
radio n. / ́reidiou/ sóng vô tuyến, radio
...
react v. /ri ́ækt/ tác động trở lại, phản ứng
reaction n. /ri:'ækʃn/ sự phản ứng; sự phản tác dụng
read v. /ri:d/ đọc
reading n. / ́ri:diη/ sự đọc
reader n. / ́ri:də/ người đọc, độc giả
...
reasonable adj. / ́ri:zənəbl/ có lý, hợp lý
reasonably adv. / ́ri:zənəblli/ hợp lý
unreasonable adj. /ʌnˈrizənəbəl/ vô lý
recall v. /ri ́kɔ:l/ gọi về, triệu hồi; nhặc lại, gợi lại
receipt n. /ri ́si:t/ công thức; đơn thuốc
receive v. /ri'si:v/ nhận, lĩnh, thu
recent adj. / ́ri:sənt/ gần đây, mới đây
recently adv. / ́ri:səntli/ gần đây, mới đây
...
record n., v. / ́rekɔ:d/ bản ghi, sự ghi, bản thu, sự thu; thu, ghi chép
recording n. /ri ́kɔ:diη/ sự ghi, sự thu âm
recover v. /'ri:'kʌvə/ lấy lại, giành lại
red adj., n. /red/ đỏ; màu đỏ
reduce v. /ri'dju:s/ giảm, giảm bớt
reduction n. /ri ́dʌkʃən/ sự giảm giá, sự hạ giá
...
reform v., n. /ri ́fɔ:m/ cải cách, cải thiện, cải tạo; sự cải cách, sự cải thiện, cải tạo
refrigerator n. /ri'fridЗзreitз/ tủ lạnh
refusal n. /ri ́fju:zl/ sự từ chối, sự khước từ
refuse v. /rɪˈfyuz/ từ chối, khước từ
regard v., n. /ri'gɑ:d/ nhìn, đánh giá; cái nhìn, sự quan tâm, sự chú ý (lời chúc tụng
cuối thư)
regarding prep. /ri ́ga:diη/ về, về việc, đối với (vấn đề...)
...
regularly adv. / ́regjuləli/ đều đặn, thường xuyên
regulation n. / ̧regju ́leiʃən/ sự điều chỉnh, điều lệ, quy tắc
...
relax v. /ri ́læks/ giải trí, nghỉ ngơi
relaxed adj. /ri ́lækst/ thanh thản, thoải mái
...
relevant adj. / ́reləvənt/ thích hợp, có liên quan
...
rely on v. /ri ́lai/ tin vào, tin cậy, tin tưởng vào
remain v. /riˈmein/ còn lại, vẫn còn như cũ
remaining adj. /ri ́meiniη/ còn lại
...
repeated adj. /ri ́pi:tid/ được nhắc lại, được lặp lại
repeatedly adv. /ri ́pi:tidli/ lặp đi lặp lại nhiều lần
...
rescue v., n. / ́reskju:/ giải thoát, cứu nguy; sự giải thoát, sự cứu nguy
...
resistance n. /ri ́zistəns/ sự chống lại, sự phản đối, sự kháng cự
resolve v. /ri'zɔlv/ quyết định, kiên quyết (làm gì); giải quyết (vấn đề, khó khăn..)
resort n. /ri ́zɔ:t/ kế sách, phương kế
...
restaurant n. / ́restərɔn/ nhà hàng ăn, hiệu ăn
restore v. /ris ́tɔ:/ hoàn lại, trả lại; sửa chữa lại, phục hồi lại
restrict v. /ris ́trikt/ hạn chế, giới hạn
restricted adj. /ris ́triktid/ bị hạn chế, có giới hạn; vùng cấm
...
retire v. /ri ́taiə / rời bỏ, rút về; thôi, nghỉ việc, về hưu
retired adj. /ri ́taiəd/ ẩn dật, hẻo lánh, đã về hưu, đã nghỉ việc
...
review n., v. /ri ́vju:/ sự xem lại, sự xét lại; làm lại, xem xét lại
revise v. /ri'vaiz/ đọc lại, xem lại, sửa lại, ôn lại
revision n. /ri ́viʒən/ sự xem lại, sự đọc lại, sự sửa lại, sự ôn lại
...
riding n. / ́raidiη/ môn thể thao cưỡi ngựa, sự đi xe (bus, điện, xe đạp)
rider n. / ́raidə/ người cưỡi ngựa, người đi xe đạp
...
phải
rightly adv. / ́raitli/ đúng, phải, có lý
...
rounded adj. / ́raundid/ bị làm thành tròn; phát triển đầy đủ
...
ruler n. / ́ru:lə/ người cai trị, người trị vì; thước kẻ
rumour n. /ˈrumər/ tin đồn, lời đồn
run v., n. /rʌn/ chạy; sự chạy
running n. /'rʌniɳ/ sự chạy, cuộc chạy đua
runner n. / ́rʌnə/ người chạy
rural adj. / ́ruərəl/ (thuộc) nông thôn, vùng nông thôn
...
salt n. /sɔ:lt/ muối
salty adj. / ́sɔ:lti/ chứ vị muối, có muối, mặn
same adj., pron. /seim/ đều đều, đơn điệu; cũng như thế, vẫn cái đó
sample n. / ́sa:mpl/ mẫu, hàng mẫu
sand n. /sænd/ cát
...
save v. /seiv/ cứu, lưu
saving n. / ́seiviη/ sự cứu, sự tiết kiệm
say v. /sei/ nói
...
schedule n., v. / ́ʃkedju:l/ kế hoạch làm việc, bản liệt kê; lên thời khóa biểu, lên kế
hoạch
...
select v. /si ́lekt/ chọn lựa, chọn lọc
selection n. /si'lekʃn/ sự lựa chọn, sự chọc lọc
self n. /self/ bản thân mình
self- combining form
sell v. /sel/ bán
senate n. / ́senit/ thượng nghi viện, ban giám hiệu
...
separation n. / ̧sepə ́reiʃən/ sự chia cắt, phân ly, sự chia tay, ly thân
September n. (abbr. Sept.) /sep ́tembə/ tháng 9
...
severely adv. /sə ́virli/ khắt khe, gay gắt (thái độ, cư xử); giản dị, mộc mạc (kiểu
cách, trang phục, dung nhan)
sew v. /soʊ/ may, khâu
sewing n. / ́souiη/ sự khâu, sự may vá
...
mạnh, gây sốc
shocking adj. / ́ʃɔkiη/ gây ra căm phẫn, tồi tệ, gây kích động
...
shortly adv. / ́ʃɔ:tli/ trong thời gian ngắn, sớm
...
shower n. / ́ʃouə/ vòi hoa sen, sự tắm vòi hoa sen
...
sideways adj., adv. / ́saidwə:dz/ ngang, từ một bên; sang bên
...
silly adj. / ́sili/ ngớ ngẩn, ngu ngốc, khờ dại
silver n., adj. /'silvə/ bạc, đồng bạc; làm bằng bạc, trắng như bạc
similar adj. / ́similə/ giống như, tương tự như
similarly adv. / ́similəli/ tương tự, giống nhau
simple adj. /'simpl/ đơn, đơn giản, dễ dàng
simply adv. / ́simpli/ một cách dễ dàng, giản dị
since prep., conj., adv. /sins/ từ, từ khi; từ khi, từ lúc đó; từ đó, từ lúc ấy
sincere adj. /sin ́siə/ thật thà, thẳng thắng, chân thành
...
singing n. / ́siηiη/ sự hát, tiếng hát
singer n. / ́siηə/ ca sĩ
...
skilful (BrE) (NAmE skillful) adj. / ́skilful/ tài giỏi, khéo tay
skilfully (BrE) (NAmE skillfully) adv. / ́skilfulli/ tài giỏi, khéo tay
...
socially adv. / ́souʃəli/ có tính xã hội
...
somehow adv. / ́sʌm ̧hau/ không biết làm sao, bằng cách này hay cách khác
something pron. /'sʌmθiɳ/ một điều gì đó, một việc gì đó, một cái gì đó
sometimes adv. / ́sʌm ̧taimz/ thỉnh thoảng, đôi khi
somewhat adv. / ́sʌm ̧wɔt/ đến mức độ nào đó, hơi, một chút
...
Nam
southern adj. / ́sʌðən/ thuộc phương Nam
...
specially adv. / ́speʃəli/ đặc biệt, riêng biệt
...
spelling n. / ́speliη/ sự viết chính tả
spend v. /spɛnd/ tiêu, xài
spice n. /spais/ gia vị
spicy adj. / ́spaisi/ có gia vị
spider n. / ́spaidə/ con nhện
...
unsteady adj. /ʌn ́stedi/ không chắc, không ổn định
...
studio n. / ́stju:diou/ xưởng phim, trường quay; phòng thu
...
substantial adj. /səb ́stænʃəl/ thực tế, đáng kể, quan trọng
substantially adv. /səb ́stænʃəli/ về thực chất, về căn bản
substitute n., v. / ́sʌbsti ̧tju:t/ người, vật thay thế; thay thế
...
unsuccessful adj. / ̧ʌnsək ́sesful/ không thành công, thất bại
...
suited adj. / ́su:tid/ hợp, phù hợp, thích hợp với
suitable adj. / ́su:təbl/ hợp, phù hợp, thích hợp với
suitcase n. / ́su:t ̧keis/ va li
sum n. /sʌm/ tổng, toàn bộ
summary n. /ˈsʌməri/ bản tóm tắt
summer n. /ˈsʌmər/ mùa hè
sun n. /sʌn/ mặt trời
Sunday n. (abbr. Sun.) / ́sʌndi/ Chủ nhật
superior adj. /su:'piəriə(r)/ cao, chất lượng cao
supermarket n. / ́su:pə ̧ma:kit/ siêu thị
supply n., v. /sə'plai/ sự cung cấp, nguồn cung cấp; cung cấp, đáp ứng, tiếp tế
support n., v. /sə ́pɔ:t/ sự chống đỡ, sự ủng hộ; chống đỡ, ủng hộ
supporter n. /sə ́pɔ:tə/ vật chống đỡ; người cổ vũ, người ủng hộ
suppose v. /sə'pəƱz/ cho rằng, tin rằng, nghĩ rằng
sure adj., adv. /ʃuə/ chắc chắn, xác thực
make sure chắc chắn, làm cho chắc chắn
surely adv. / ́ʃuəli/ chắc chắn
...
surprising adj. /sə: ́praiziη/ làm ngạc nhiên, làm bất ngờ
surprisingly adv. /sə'praiziηli/ làm ngạc nhiên, làm bất ngờ
surprised adj. /sə: ́praizd/ ngạc nhiên (+ at)
surround v. /sə'raƱnd/ vây quanh, bao quanh
surrounding adj. /sə.ˈrɑʊn.diɳ/ sự vây quanh, sự bao quanh
surroundings n. /sə ́raundiηz/ vùng xung quanh, môi trường xung quanh
...
suspect v., n. /səs ́pekt/ nghi ngờ, hoài nghi; người khả nghi, người bị tình nghi
suspicion n. /səs'pi∫n/ sự nghi ngờ, sự ngờ vực
suspicious adj. /səs ́piʃəs/ có sự nghi ngờ, tỏ ra nghi ngờ, khả nghi
...
swelling n. / ́sweliη/ sự sưng lên, sự phồng ra
swollen adj. / ́swoulən/ sưng phồng, phình căng
swim v. /swim/ bơi lội
swimming n. / ́swimiη/ sự bơi lội
...
swollen swell v. / ́swoulən/ /swel/ phồng lên, sưng lên
symbol n. /simbl/ biểu tượng, ký hiệu
sympathetic adj. / ̧simpə ́θetik/ đồng cảm, đáng mến, dễ thương
sympathy n. / ́simpəθi/ sự đồng cảm, sự đồng ý
...
telephone (also phone) n., v. / ́telefoun/ máy điện thoại, gọi điện thoại
television (also TV) n. / ́televiʒn/ vô tuyến truyền hình
tell v. /tel/ nói, nói với
temperature n. / ́tempritʃə/ nhiệt độ
...
thickness n. / ́θiknis/ tính chất dày, độ dày, bề dày
...
thirsty adj. / ́θə:sti/ khát, cảm thấy khát
...
threatening adj. / ́θretəniη/ sự đe dọa, sự hăm dọa
...
Thursday n. (abbr. Thur., Thurs.) / ́θə:zdi/ thứ 5
thus adv. /ðʌs/ như vậy, như thế, do đó
ticket n. /'tikit/ vé
tidy adj., v. / ́taidi/ sạch sẽ, ngăn nắp, gọn gàng; làm cho sạch sẽ, gọn gàng, ngăn nắp
untidy adj. /ʌn ́taidi/ không gọn gàng, không ngăn nắp, lộn xộn
...
timetable n. (especially BrE) / ́taimteibl/ kế hoạch làm việc, thời gian biểu
tin n. /tɪn/ thiếc
tiny adj. /'taini/ rất nhỏ, nhỏ xíu
tip n., v. /tip/ đầu, mút, đỉnh, chóp; bịt đầu, lắp đầu vào
tire v. (BrE, NAmE), n. (NAmE) (BrE tyre /'taiз/) / ́taiə/ làm mệt mỏi, trở nên mệt
nhọc; lốp, vỏ xe
tiring adj. / ́taiəriη/ sự mệt mỏi, sự mệt nhọc
...
toilet n. / ́tɔilit/ nhà vệ sinh; sự trang điểm (rửa mặt, ăn mặc, chải tóc...)
tomato n. /tə ́ma:tou/ cà chua
tomorrow adv., n. /tə'mɔrou/ vào ngày mai; ngày mai
ton n. /tΔn/ tấn
tone n. /toun/ tiếng, giọng
tongue n. /tʌη/ lưỡi
tonight adv., n. /tə ́nait/ vào đêm nay, vào tối nay; đêm nay, tối nay
tonne n. /tʌn/ tấn
too adv. /tu:/ cũng
...
towards (also toward especially in NAmE) prep. /tə ́wɔ:dz/ theo hướng, về hướng
...
tradition n. /trə ́diʃən/ truyền thống
traditional adj. /trə ́diʃənəl/ theo truyền thống, theo lối cổ
traditionally adv. /trə ́diʃənəlli/ (thuộc) truyền thống, là truyền thống
...
translate v. /træns ́leit/ dịch, biên dịch, phiên dịch
translation n. /træns'leiʃn/ sự dịch
transparent adj. /træns ́pærənt/ trong suốt; dễ hiểu, sáng sủa
...
Tuesday n. (abbr. Tue., Tues.) / ́tju:zdi/ thứ 3
...
typical adj. / ́tipikəl/ tiêu biểu, điển hình, đặc trưng
typically adv. / ́tipikəlli/ điển hình, tiêu biểu
tyre n. (BrE) (NAmE tire) /'taiз/ lốp, vỏ xe
ugly adj. /'ʌgli/ xấu xí, xấu xa
ultimate adj. /ˈʌltəmɪt/ cuối cùng, sau cùng
ultimately adv. / ́ʌltimətli/ cuối cùng, sau cùng
umbrella n. /ʌm'brelə/ ô, dù
unable able /ʌn ́eibl/ không thể, không có khẳ năng (# có thể)
unacceptable acceptable / ̧ʌnək ́septəbl/ không thể chấp nhận
uncertain certain /ʌn'sə:tn/ không chắc chắn, khôn biết rõ ràng
uncle n. /ʌηkl/ chú, bác
uncomfortable comfortable /ʌη ́kʌmfətəbl/ bất tiện, không tiện lợi
...
underneath prep., adv. / ̧ʌndə ́ni:θ/ dưới, bên dưới
understand v. /ʌndə'stænd/ hiểu, nhận thức
understanding n. /ˌʌndərˈstændɪŋ/ trí tuệ, sự hiểu biết
underwater adj., adv. / ́ʌndə ̧wɔtə/ ở dưới mặt nước, dưới mặt nước
underwear n. /'ʌndəweə/ quần lót
undo do /ʌn ́du:/ tháo, gỡ, xóa, hủy bỏ
unemployed employ / ̧ʌnim ́plɔid/ không dùng, thất nghiệp
unemployment employment /'Δnim'ploimзnt/ sự thất nghiệp, tình trạng thất nghiệp
unexpected, unexpectedly expect / ̧ʌniks ́pektid/ bất ngờ, đột ngột, gây ngạc nhiên
unfair, unfairly fair /ʌn ́fɛə/ không đúng, không công bằng, gian lận
unfortunate adj. /Λnfo:'t∫əneit/ không may, rủi ro, bất hạnh
unfortunately adv. /ʌn ́fɔ:tʃənətli/ một cách đáng tiếc, một cách không may
unfriendly friendly /ʌn ́frendli/ đối địch, không thân thiện
unhappiness happiness /ʌn ́hæpinis/ sự buồn, nỗi buồn
unhappy happy /ʌn ́hæpi/ buồn rầu, khổ sở
uniform n., adj. /ˈjunəˌfɔrm/ đồng phục; đều, giống nhau, đồng dạng
unimportant important / ̧ʌnim ́pɔ:tənt/ không quan trọng
union n. /'ju:njən/ liên hiệp, sự đoàn kết, sự hiệp nhất
unique adj. /ju: ́ni:k/ độc nhất vô nhị
unit n. /'ju:nit/ đơn vị
unite v. /ju: ́nait/ liên kết, hợp nhất, hợp lại, kết thân
united adj. /ju:'naitid/ liên minh, đoàn kết, chung, thống nhất
universe n. /'ju:nivə:s/ vũ trụ
university n. / ̧ju:ni ́və:siti/ trường đại học
unkind kind /ʌn ́kaind/ không tử tế, không tốt
unknown know /'ʌn'noun/ không biết, không được nhận ra
unless conj. /ʌn ́les/ trừ phi, trừ khi, nếu không
unlike like /ʌn ́laik/ không giống, khác
unlikely likely /ʌnˈlaɪkli/ không có thể xảy ra, không chắc chắn; không có thực
unload load /ʌn ́loud/ tháo, dỡ
unlucky lucky /ʌn ́lʌki/ không gặp may, không may mắn
...
unsteady steady /ʌn ́stedi/ không đúng mực, không vững, không chắc
unsuccessful successful / ̧ʌnsək ́sesful/ không thành công, không thành đạt
untidy tidy /ʌn ́taidi/ không gọn gàng, không ngăn nắp, lộn xộn
until (also till) conj., prep. /ʌn ́til/ trước khi, cho đến khi
unusual, unusually usual /ʌn ́ju:ʒuəl/ hiếm, khác thường
unwilling, unwillingly willing /ʌn ́wiliη/ không muốn, không có ý định
up adv., prep. /Λp/ ở trên, lên trên, lên
upon prep. /ə ́pɔn/ trên, ở trên
upper adj. / ́ʌpə/ cao hơn
upset v., adj. /ʌpˈsɛt/ làm đổ, đánh đổ
upsetting adj. /ʌp ́setiη/ tính đánh đổ, làm đổ
upside down adv. / ́ʌp ̧said/ lộn ngược
upstairs adv., adj., n. / ́ʌp ́stɛəz/ ở tên gác, cư ngụ ở tầng gác; tầng trên, gác
...
useful adj. / ́ju:sful/ hữu ích, giúp ích
useless adj. /'ju:slis/ vô ích, vô dụng
user n. / ́ju:zə/ người dùng, người sử dụng
usual adj. /'ju:ʒl/ thông thường, thường dùng
usually adv. /'ju:ʒəli/ thường thường
unusual adj. /ʌn ́ju:ʒuəl/ hiếm, khác thường, đáng chú ý
unusually adv. /ʌn ́ju:ʒuəlli/ cực kỳ, khác thường
...
variation n. / ̧veəri ́eiʃən/ sự biến đổi, sự thay đổi mức độ, sự khác nhau
...
vocabulary n. /və ́kæbjuləri/ từ vựng
voice n. /vɔis/ tiếng, giọng nói
volume n. / ́vɔlju:m/ thế tích, quyển, tập
...
weakness n. / ́wi:knis/ tình trạng yếu đuối, yếu ớt
...
Wednesday n. (abbr. Wed., Weds.) / ́wensdei/ thứ 4
week n. /wi:k/ tuần, tuần lễ
weekend n. / ̧wi:k ́end/ cuối tuần
weekly adj. / ́wi:kli/ mỗi tuần một lần, hàng tuần
...
whatever det., pron. /wɔt ́evə/ bất cứ thứ gì, bất kể thứ gì
wheel n. /wil/ bánh xe
...
whether conj. / ́weðə/ có..không; có... chăng; không biết có.. không
...
whisper v., n. / ́wispə/ nói thì thầm, xì xào; tiếng nói thì thầm, tiếng xì xào
...
widely adv. / ́waidli/ nhiều, xa; rộng rãi
...
willing adj. / ́wiliη/ bằng lòng, vui lòng, muốn
willingly adv. /'wiliηli/ sẵn lòng, tự nguyện
unwilling adj. /ʌn ́wiliη/ không sẵn lòng, miễn cưỡng
unwillingly adv. /ʌn ́wiliηgli/ không sẵn lòng, miễn cưỡng
willingness n. / ́wiliηnis/ sự bằng lòng, sự vui lòng
win v. /win/ chiếm, đọat, thu được
winning adj. / ́winiη/ đang dành thắng lợi, thắng cuộc
...
within prep. /wið ́in/ trong vong thời gian, trong khoảng thời gian
...
wonderful adj. / ́wʌndəful/ phi thường, khác thường, kỳ diệu, tuyệt vời
wood n. /wud/ gỗ
wooden adj. / ́wudən/ làm bằng gỗ
wool n. /wul/ len
word n. /wə:d/ từ
work v., n. /wɜ:k/ làm việc, sự làm việc
working adj. / ́wə:kiη/ sự làm, sự làm việc
worker n. /'wə:kə/ người lao động
world n. /wɜ:ld/ thế giới
worry v., n. /'wʌri/ lo lắng, suy nghĩ; sự lo lắng, suy nghĩ
worrying adj. / ́wʌriiη/ gấy lo lắng, gây lo nghĩ
worried adj. / ́wʌrid/ bồn chồn, lo nghĩ, tỏ ra lo lắng
worse, worst bad xấu
...
zone n. /zoun/ khu vực, miền, vùng, create json array with fields 
...
`;
  ...
  parseVocabulary(text: string) {
    ...
    for (const line of lines) {
      ...
      if (match) {
        const [, english, partOfSpeech, vietnamese] = match;
        result.push({
          id: id++,
          english: english,
